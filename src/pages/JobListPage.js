...
import {
  Box, Fade, Grid, Pagination, Typography, PaginationItem,
} from '@mui/material';
  ...
  return (
    <Box className="pb-7" sx={{width: '100%', minHeight: '100vh', background: 'linear-gradient(to right, #868686, #5C5C5C)'}}>
      ...
      <div className="mx-7 relative">
        <Box className="border border-gray-500 rounded-xl p-6 shadow-[2px_2px_4px_rgba(0,0,0,0.25)] bg-white">
          <Box display="flex" alignItems="center" className="mb-5">
            <Box className="w-1 h-4 rounded-sm bg-orange-700 mr-[7px]" />
